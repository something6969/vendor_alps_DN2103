...
#ifdef OPLUS_FEATURE_WIFI_WIFICOND_RECOVERY
#Lei.Zhang@CONNECTOVITY.WIFI.HARDWARE.SWITCH.1069763, 2021/06/08, add for wificond recovery
function triggerWificondRecovery() {
    /system/bin/stop wificond
    sleep 1
    /system/bin/start wificond
    setprop sys.oplus.wifi.wificond.recovery.start "0"
}
#endif /* OPLUS_FEATURE_WIFI_WIFICOND_RECOVERY */
